                    ...
                    <Col :md="12" :lg="24" :style="{marginBottom: '10px'}">
                        <Card>
                            <p slot="title" class="card-title">
                                <Icon type="social-google" :size="18"></Icon>
                                <a href="https://github.com" target="_blank"> 快速入口 </a>
                            </p>
                            <div class="to-do-list-con">
                                <Timeline>
                                    <TimelineItem color="green">
                                        <a href="https://github.com" target="_blank">工作流</a>
                                    </TimelineItem>
                                    <TimelineItem color="green">
                                        <a href="https://github.com" target="_blank">商品审核</a>
                                    </TimelineItem>
                                    <TimelineItem color="red">
                                        <a href="https://github.com" target="_blank">订单管理</a>
                                    </TimelineItem>
