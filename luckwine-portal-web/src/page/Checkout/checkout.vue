        ...
        <div slot="content">
          <ul class="address-item-list clearfix">
            <li v-for="(item,i) in addList"
                ...
                @click="defaultAddress(item.goodsAddrId)">
           <span v-if="addressId === item.goodsAddrId" class="pa">
             ...
             <path
              ...
              <p>手机号码: {{item.moblie}}</p>
              <div class="operation-section">
                <span class="update-btn" @click="update(item)">修改</span>
                <span class="delete-btn" :data-id="item.goodsAddrId" @click="del(item.goodsAddrId)">删除</span>
              </div>
            </li>
