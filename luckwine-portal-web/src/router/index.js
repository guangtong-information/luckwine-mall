...
const Favorable = resolve => require(['/page/Voucher/favorable'], resolve)
...
const balance = resolve => require(['/page/User/children/balance'], resolve)
  ...
  routes: [
    {
      ...
      children: [
        ...
        {path: 'favorable', component: Favorable},
        {path: 'goods/:categoryId-:brandId', component: GoodS},
    ...
    },
    {
      ...
      children: [
        ...
        {path: 'balance', name: '我的余额', component: balance}
      ]
    },
