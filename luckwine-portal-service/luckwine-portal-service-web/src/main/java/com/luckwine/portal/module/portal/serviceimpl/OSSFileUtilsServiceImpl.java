...
public class OSSFileUtilsServiceImpl {
    ...
    @Value("${portal.endpoint}")
    private String endpoint;

    @Value("${portal.accessKeyId}")
    private String accessKeyId;

    @Value("${portal.accessKeySecret}")
    private String accessKeySecret;

    @Value("${portal.ossPath}")
    private String ossPath;

    @Value("${portal.bucketName}")
    ...
    /**
     * portal tmp 文件夹定时清理，保存数据请调用 OSSFileUtilsServiceImpl().save()
     * @param inputStream
     * @param filename
     * @return
     */
