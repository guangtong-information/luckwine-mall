 ...
 * 商品重复覆盖测试
 */
public class RepeatGoodsTest extends BaseTest {
    ...
    public void testRepeatFail() {
        //重复sku的商品3
        ConsumeOrderRequest createOrderRequest = (ConsumeOrderRequest) BaseTest.request.getRequest();
        List<GoodsOrderRequest> orderGoodsList = createOrderRequest.getOrderGoodsList();
        //商品3
        GoodsOrderRequest GoodsOrderRequest3 = new GoodsOrderRequest();
        GoodsOrderRequest3.setSkuId("10000094");
        GoodsOrderRequest3.setCartId("5");
        GoodsOrderRequest3.setGoodsCount(1L);
        orderGoodsList.add(GoodsOrderRequest3);
